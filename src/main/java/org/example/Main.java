...
public class Main {
    String[][] bookList = {
            {"1234", "Kalkulus", "King S", "2"},
            {"5678", "Crypto Tranding Guide", "AKADEMIK CRYPTO", "3"},
            {"8910", "Atomic Habits", "JAMES CLEAR", "1"}
    };
    String[][] userStudent = {
            {"Andika", "202310370311173", "Teknik", "Informatika"}
    };
